...
void Application::Update(float deltaTime)
{
    ...
    if (input_.IsKeyPressed(VK_F1))
    {
        const bool nextCullingState =
            !terrainChunkManager_.IsCullingEnabled();
        ...
        terrainChunkManager_.SetCullingEnabled(
            nextCullingState);
    }
    ...
    if (input_.IsKeyPressed(VK_F2))
    {
        const bool nextLODState =
            !terrainChunkManager_.IsLODEnabled();
        ...
        terrainChunkManager_.SetLODEnabled(
            nextLODState);
    }
    ...
    {
        terrainChunkManager_.SetChunkBoundsVisible(
            !terrainChunkManager_.IsChunkBoundsVisible());
    }
