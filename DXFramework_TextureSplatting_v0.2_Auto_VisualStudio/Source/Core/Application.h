...
private:
    ...
    // --------------------------------------------------------------------
    // 선택 기능: Texture Splatting Terrain
    //
    // HeightMap Geometry + TextureSplatMaterial을 사용하는 독립 Feature.
    // 기존 HeightMapTerrain 자체를 수정하지 않고 별도 객체로 연결한다.
    // --------------------------------------------------------------------
    TextureSplatTerrain textureSplatTerrain_;
