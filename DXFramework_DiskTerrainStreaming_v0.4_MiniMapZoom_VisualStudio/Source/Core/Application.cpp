...
bool Application::Initialize(HINSTANCE instance)
{
    ...
    if(!window_.Initialize(instance,1280,720,L"DirectX 11 - Large Terrain / Custom UI"))
...
void Application::Update(float dt)
{
    ...
    cameraController_.Update(camera_,input_,dt,allowOrbit);
...
void Application::Render()
{
    ...
    {
        // 설정 패널은 항상 표시. F1~F6 기능은 체크박스로 제어한다.
        uiManager_.Render(uiRenderer_);
        // 기존 F3 통계는 UI의 Debug Statistics Checkbox에 연결한다.
