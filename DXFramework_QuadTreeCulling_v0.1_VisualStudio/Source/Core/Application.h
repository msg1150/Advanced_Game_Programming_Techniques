...
private:
    ...
    // --------------------------------------------------------------------
    // 선택 기능: QuadTree Culling Terrain
    //
    // HeightMap + Texture Splatting 결과를 그대로 사용하면서
    // QuadTree와 Camera Frustum으로 보이지 않는 Terrain 영역을 제외한다.
    // --------------------------------------------------------------------
    QuadTreeTerrain quadTreeTerrain_;
